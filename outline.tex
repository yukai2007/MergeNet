...
\begin{itemize}
    ...
    \item 利用 Perceiver-style Cross-Attention （perciever）将聚合后的语义“概念”压缩为固定长度的 Latent Vectors，实现高压缩率。
...
\section{Experiments}
\input{tab_lin_attn_350m_commen_sence}
\input{tab_lin_attn_350m_longbench}
