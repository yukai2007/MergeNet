...
\begin{itemize}
    ...
    \end{align}
    这个 source-aware bias 只对应完整 source matrix 路径；若采用轻量 center trace，则没有该项 source bias。OpenToMe 当前 CLS 分类路径会消费 \texttt{token\_center} 做排序，但 center 模式仍应视作 dense source/bias off 的轻量路径。
